...
public class ParameterUtils {
    ...
    public static String curingGlobalParams(Map<String, String> globalParamMap, List<Property> globalParamList,
        ...
        for (Map.Entry<String, String> entry : entries) {
            ...
            if (val.startsWith("$")) {
                String str = org.apache.dolphinscheduler.common.utils.ParameterUtils.convertParameterPlaceholders(val, allParamMap);
    ...
    public static String dateTemplateParse(String templateStr) {
        if (templateStr == null) {
            return null;
        }
        Pattern pattern = Pattern.compile(DATE_PARSE_PATTERN);
...
//        String a = "'$[yyyyMMdd-1]',$[yyyyMMdd-2]";
        String a = "'$[yyyyMMdd-1]',";
        System.out.println(dateTemplateParse(a));
    }

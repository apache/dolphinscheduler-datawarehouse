...
public class UserGroup {
    ...
    public String getUserMailPre() {
        return userMailPre;
    }

    public void setUserMailPre(String userMailPre) {
        this.userMailPre = userMailPre;
    }
    ...
    public boolean equals(Object o) {
        ...
        return userMailPre.equals(user.userMailPre);
    ...
    public int hashCode() {
        int result = userId;
        result = 31 * result + userMailPre.hashCode();
        return result;
    }
}
